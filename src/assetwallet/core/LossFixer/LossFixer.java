...
public class LossFixer extends Servant {
    ...
    public boolean processLossfix(ArrayList<Asset> ccs) {
        String[] results;
        String[] requests;
        StringBuilder[] sbs;
        String[] posts;
        ...
        for (i = 0; i < RAIDA.TOTAL_RAIDA_COUNT; i++) {
            ...
            if (results[i] != null) {
                if (results[i].equals("")) {
                    ...
                    setCoinStatus(ccs, i, Asset.STATUS_UNTRIED);
                    continue;
                }
            }
    ...
    public void moveCoinToFracked(Asset cc) {
